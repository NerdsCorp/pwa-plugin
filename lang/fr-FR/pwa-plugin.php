...
return [
    ...
    'preferences' => [
        'section_title' => 'Préférences de notification',
        'section_description' => 'Choisissez les catégories de notifications que vous souhaitez recevoir et leur fréquence.',
        'channels_label' => 'Catégories de notifications',
        'digest_mode_label' => 'Mode d’envoi',
        'digest_mode_instant' => 'Instantané',
        'digest_mode_daily' => 'Résumé quotidien',
        'quiet_hours_label' => 'Activer les heures silencieuses',
